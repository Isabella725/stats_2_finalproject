...
# Conclusions
This topic is ripe for study. However, without a different dataset, or at least an unrestricted version of this dataset, there is no way to satisfactorily answer the research question. The results in this paper would indicate that climate change beliefs do not have a negative impact on fertility rates. However, without a better dependent variable, I am skeptical of the results found. Knowing women's actually ferility rates is key to understanding this research question.
