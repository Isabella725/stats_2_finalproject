...
#added in controls
model.age<- glm(children~age,data = anes, family=binomial(logit))
model.age
model.both <-glm(children~climatebelief + age, data=anes, family=binomial(logit))
model.both

texreg(list(model.glm,model.age,model.both),
          caption="Test Models",
          custom.coef.names = "Intercept","Climate Belief","Age")
```
